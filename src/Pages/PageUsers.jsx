  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        <div className="flex">
          <h2 className="w-[145px] cursor-pointer rounded-t-lg bg-pink_l p-4 text-center text-md font-medium leading-[24px] shadow-t">
            Usuarios
          </h2>
          <h2 className="w-[145px] cursor-pointer rounded-t-lg bg-black_l p-4 text-center text-md font-medium leading-[24px]">
            Roles
          </h2>
        </div>
