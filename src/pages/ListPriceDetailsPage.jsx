...
const ListPriceDetailsPage = () => {
  ...
  const { userSellerResponse, setRoute, setIsActive } = useUsersSellers();
        ...
        <div className="flex items-center">
          <div className="flex">
            <h2
              ...
              className={`w-40 cursor-pointer rounded-t-lg ${activeTab === PRODUCTS_TAB ? "bg-white text-black_b" : "bg-gray text-black_m"} p-4 text-center text-md font-medium leading-6 shadow-t`}
            >
              Productos
            </h2>
            <h2
